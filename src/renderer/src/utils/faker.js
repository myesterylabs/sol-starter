...
// // Use require.context to create a context for the specified directory and file pattern
// const imageContext = require.context('./assets/images/', false, /\.(jpg|jpeg|png|svg)$/);

// // Import all modules matching the pattern
// const imageAssets = importAll(imageContext);
// const fakers = {
//   fakeUsers() {
//     const users = [
